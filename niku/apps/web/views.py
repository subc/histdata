...
class IndexView(BaseView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        foresee_daily_risk = int(ai_units * DAILY_RISK_COEFFICIENT)
        foresee_margin = int(ai_units * MARGIN_COEFFICIENT)
        daily_risk = int(sum([o.profit for o in order_week]) / 10)
