...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeneticHistory.elite'
        db.add_column(u'genetic_genetichistory', 'elite',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GeneticHistory.elite'
        db.delete_column(u'genetic_genetichistory', 'elite')
