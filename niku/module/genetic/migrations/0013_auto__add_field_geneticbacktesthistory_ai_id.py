...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeneticBackTestHistory.ai_id'
        db.add_column(u'genetic_geneticbacktesthistory', 'ai_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GeneticBackTestHistory.ai_id'
        db.delete_column(u'genetic_geneticbacktesthistory', 'ai_id')
    ...
    models = {
        u'genetic.geneticbacktesthistory': {
            ...
            'ai_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
