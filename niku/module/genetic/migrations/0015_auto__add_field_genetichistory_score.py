...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeneticHistory.score'
        db.add_column(u'genetic_genetichistory', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GeneticHistory.score'
        db.delete_column(u'genetic_genetichistory', 'score')
