...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'GeneticHistory', fields ['elite']
        db.create_index(u'genetic_genetichistory', ['elite'])


    def backwards(self, orm):
        # Removing index on 'GeneticHistory', fields ['elite']
        db.delete_index(u'genetic_genetichistory', ['elite'])
