...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GeneticBackTestHistory'
        db.create_table(u'genetic_geneticbacktesthistory', (
            ...
            ('span', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'genetic', ['GeneticBackTestHistory'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GeneticBackTestHistory'
        db.delete_table(u'genetic_geneticbacktesthistory')
