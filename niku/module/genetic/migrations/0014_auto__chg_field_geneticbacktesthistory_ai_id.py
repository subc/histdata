...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GeneticBackTestHistory.ai_id'
        db.alter_column(u'genetic_geneticbacktesthistory', 'ai_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'GeneticBackTestHistory.ai_id'
        db.alter_column(u'genetic_geneticbacktesthistory', 'ai_id', self.gf('django.db.models.fields.IntegerField')())
