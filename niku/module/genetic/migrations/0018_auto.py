...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'GeneticHistory', fields ['profit']
        db.create_index(u'genetic_genetichistory', ['profit'])

        # Adding index on 'GeneticHistory', fields ['score']
        db.create_index(u'genetic_genetichistory', ['score'])


    def backwards(self, orm):
        # Removing index on 'GeneticHistory', fields ['score']
        db.delete_index(u'genetic_genetichistory', ['score'])

        # Removing index on 'GeneticHistory', fields ['profit']
        db.delete_index(u'genetic_genetichistory', ['profit'])
