...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'GeneticHistory', fields ['elite', u'id', 'currency_pair']
        db.create_unique(u'genetic_genetichistory', ['elite', u'id', 'currency_pair'])


    def backwards(self, orm):
        # Removing unique constraint on 'GeneticHistory', fields ['elite', u'id', 'currency_pair']
        db.delete_unique(u'genetic_genetichistory', ['elite', u'id', 'currency_pair'])
    ...
    models = {
        ...
        u'genetic.genetichistory': {
            'Meta': {'unique_together': "((u'id', u'elite', u'currency_pair'),)", 'object_name': 'GeneticHistory'},
