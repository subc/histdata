...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeneticEliteHistory.comment'
        db.add_column(u'genetic_geneticelitehistory', 'comment',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GeneticEliteHistory.comment'
        db.delete_column(u'genetic_geneticelitehistory', 'comment')


    models = {
        u'genetic.geneticelitehistory': {
            'Meta': {'unique_together': "((u'genetic_id',),)", 'object_name': 'GeneticEliteHistory'},
            'comment': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True'}),
