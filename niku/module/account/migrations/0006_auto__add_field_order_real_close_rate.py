...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.real_close_rate'
        db.add_column(u'account_order', 'real_close_rate',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.real_close_rate'
        db.delete_column(u'account_order', 'real_close_rate')
