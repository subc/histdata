...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KillSwitch'
        db.create_table(u'account_killswitch', (
        ...
        db.send_create_signal(u'account', ['KillSwitch'])


    def backwards(self, orm):
        # Deleting model 'KillSwitch'
        db.delete_table(u'account_killswitch')
