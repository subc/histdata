...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OandaTransaction.memo'
        db.add_column(u'account_oandatransaction', 'memo',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OandaTransaction.memo'
        db.delete_column(u'account_oandatransaction', 'memo')
