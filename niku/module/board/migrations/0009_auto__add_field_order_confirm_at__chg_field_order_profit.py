...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.confirm_at'
        db.add_column(u'board_order', 'confirm_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


        # Changing field 'Order.profit'
        db.alter_column(u'board_order', 'profit', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Order.confirm_at'
        db.delete_column(u'board_order', 'confirm_at')


        # Changing field 'Order.profit'
        db.alter_column(u'board_order', 'profit', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
