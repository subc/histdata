...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'board_order', 'lowerBound')

        # Deleting field 'Order.upperBound'
        db.delete_column(u'board_order', 'upperBound')
