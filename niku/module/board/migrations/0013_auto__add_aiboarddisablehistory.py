...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AIBoardDisableHistory'
        db.create_table(u'board_aiboarddisablehistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('ai_board_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('trade_count', self.gf('django.db.models.fields.IntegerField')()),
            ('sum_tick', self.gf('django.db.models.fields.FloatField')(default=None, null=True)),
            ('open_position_tick', self.gf('django.db.models.fields.FloatField')(default=None, null=True)),
        ))
        db.send_create_signal(u'board', ['AIBoardDisableHistory'])


    def backwards(self, orm):
        # Deleting model 'AIBoardDisableHistory'
        db.delete_table(u'board_aiboarddisablehistory')
