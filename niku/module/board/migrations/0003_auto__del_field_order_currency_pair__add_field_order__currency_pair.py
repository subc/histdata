...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.currency_pair'
        db.delete_column(u'board_order', 'currency_pair')

        # Adding field 'Order._currency_pair'
        db.add_column(u'board_order', '_currency_pair',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.currency_pair'
        db.add_column(u'board_order', 'currency_pair',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Order._currency_pair'
        db.delete_column(u'board_order', '_currency_pair')
